...
import { Headphones, ExternalLink, Clock, ChevronDown, ChevronUp, Play } from 'lucide-react';
              ...
              <div className="flex items-center gap-1.5 flex-shrink-0">
                {citation.youtube_url && (
                  <button
                    ...
                    className="inline-flex items-center gap-1 px-2.5 py-1 rounded-lg bg-brand-600 hover:bg-brand-500 text-slate-950 text-xs font-bold transition-all shadow-md shadow-brand-600/20 active:scale-95"
                    title="Watch interview clip at timestamp"
                  >
